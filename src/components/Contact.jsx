...
const Contact = () => {
    return (
            ...
            <div id="contact-us" className="overflow-hidden  py-16 px-4  sm:px-6 lg:px-8 lg:py-24" name='Contact'>
                <div className="relative mx-auto max-w-xl">
                    ...
                    <div className="text-center">
                        <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 dark:text-slate-200 sm:text-4xl">Contact
                        </h2>
                        <p className="mt-4 text-lg leading-6 text-gray-500 dark:text-slate-400">Please use the form below to contact me.
                            Thank you!
                        </p>
                    </div>
                    <div className="mt-12">
                        <form action='https://getform.io/f/lbkmonzb' method='POST' className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
